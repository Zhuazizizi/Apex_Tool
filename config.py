...
Map_Dict = {
    ...
    "freedm_tdm_the_core": "核心(团队死斗)",
    "freedm_gungame_the_core": "核心(子弹时间)",
    "freedm_gungame_fragment": "碎片东部(子弹时间)",
    "control_divided_moon_production": "生产场地(控制)",
    "control_olympus_labs": "哈蒙德实验室(控制)",
    "freedm_tdm_fragment": "碎片东部(团队死斗)",
}
